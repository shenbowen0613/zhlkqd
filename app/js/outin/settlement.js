...
App.controller('settlementController', ['$scope', '$http', "ngDialog", function ($scope, $http, ngDialog) {
    ...
    $scope.print_setup = function () {//打印维护
        ...
        LODOP.ADD_PRINT_TEXT("67.31mm","280.18mm","21.96mm","27.78mm","\r\n售粮人签字\r\n  (或印)");
        LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
        LODOP.ADD_PRINT_TEXT("100.2mm","280.59mm","22.49mm","5.29mm","监管员签字");
        LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
        LODOP.ADD_PRINT_TEXT("150.22mm","280.39mm","23.81mm","5.29mm","财务复核签字");
        ...
        LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
        LODOP.ADD_PRINT_TEXT("144.99mm","7.94mm","198.97mm","7.94mm","注：本表一式四联，一联委托收储库点留存（白联）、二联售粮人留...(省略)");
        LODOP.SET_PRINT_STYLEA(0,"FontSize",11);
        LODOP.SET_PRINT_STYLEA(0,"Bold",1);
        LODOP.PRINT_SETUP();
    };
