 ...
 *      本代码仅用于智慧粮库项目.
 */
App.controller('aerateCaseController', ['$scope', '$http', '$stateParams','ngDialog', function ($scope, $http, $stateParams,ngDialog) {
    ...
    $("#goGrain").click(function () {
        window.location.href = "#/aerate/index";
    });
    $http({
            url: GserverURL+ '/aerate/caseList',
        method: 'POST'
    ...
    $scope.aerateApply = function(){ //TODO 申请通风方案
