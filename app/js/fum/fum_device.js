...
var endDate;
var table;
App.controller('fumDeviceBarController', ['$scope', function ($scope) {
    $scope.menus = menuItems;
}]);
var device_type="xunzheng";//熏蒸
App.controller('fumDeviceController', ['$scope', function ($scope) {
    $scope.gridtableid = "fumDeviceTableGrids"; //数据列表id
...
App.controller('fumDeviceViewController', ['$scope', '$http', 'ngDialog', '$filter', function ($scope, $http, ngDialog, $filter) {
    $scope.deviceView();
}]);


//列表信息处理
App.controller('fumDeviceGridController', ['$scope', "$http", "ngDialog", function ($scope, $http, ngDialog) {
    //分页动态加载数据
