 ...
 *      本代码仅用于智慧粮库项目.
 */
App.controller('aircondCaseController', ['$scope', '$http', '$stateParams','ngDialog', function ($scope, $http, $stateParams,ngDialog) {
    ...
    $("#goGrain").click(function () {
        window.location.href = "#/aircond/index";
    });
    $http({
        url: GserverURL+'/aircond/caseList',
        method: 'POST'
    ...
    $scope.aircondApply = function(){ //TODO 申请气调方案
